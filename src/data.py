question_data = [
    {
        "question": """[white]Darth Vader tells you he's your father. What do you do?:\n[/]
        [black]A. Kill him and take his place\n
        B. Try and convince him to turn to the good side of the force
        [/]""",
        "correct_answer": "B",
        "incorrect_answers": "",
    },
    {
        "question": """[white]You find out a co-worker is gossiping about you,
...
quest_data = [
    {
        "question": "You arrive at the Jedi temple on the ice planet of Ilum to seek a Kyber crystal so you can build your light sabre. You hear a song playing in the distance. What do you do?\n\n[black]A. You trust your instincts and Follow the sound.\n\nB. ignore it and Walk in the opposite direction \n",
        "correct_answer": "A",
    ...
    {
        "question": "The doors open, and you race out with your master and destroy all enemy droids in your way. You reach the room that the Commanding Viceroy is in, but the blast doors close and lock you out. Then you notice destroyer droids roll in and start shooting at you. What do you do?\n\n[black]A. Their shields are too strong, so you use your Jedi speed and escape\n\nB. you stand your ground you cant let the Commanding Viceroy get away with trying to kill you and your master\n",
        "correct_answer": "A",
...
darth_data = [
    {
        "question": "deathYou arrive at the Jedi temple on the ice planet of Ilum to seek a Kyber crystal so you can build your light sabre. You hear a song playing in the distance. What do you do?\n\n[black]A. You trust your instincts and Follow the sound.\n\nB. ignore it and Walk in the opposite direction \n",
        "correct_answer": "A",
        "incorrect_answers": "[black bold] You walk in the opposit direction and slip over and die ",
    },
    {
        "question": "deathYou get to the source of the music, and you notice it's a kyber crystal, then suddenly, you see a giant Rancor crawling out from a cave. What do you do?\n\n[black]A. You run and hide behind the nearest rock in the cave\n\nB. You realize it's the kyber crystal, and it is testing you to overcome your fear, so you charge at the rancor\n",
        "correct_answer": "B",
        "incorrect_answers": "[black bold] You start running, but the rancor catches you and kills you instantly ",
    },
    {
        "question": "deathWhen you get close to the rancor it disappears, so you grab the kyber crystal and realise you have to escape the ice cave before the entrance freezes shut. You start running back to where you came from, and you get to a fork in the cave, and you can't remember which way. What do you do?\n\n[black]A. Go left\n\nB. Go right\n",
        "correct_answer": "B",
        "incorrect_answers": "[black bold] You get to the end of the cave, and you realise it was the wrong way. The cave entrance has frozen over. You freeze to death ",
    },
    {
